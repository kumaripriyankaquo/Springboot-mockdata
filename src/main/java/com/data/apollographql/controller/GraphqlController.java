...
public class GraphqlController {
	...
	public List<Provider> getProviderList() {
		...
		provider.setState("CA");

		Provider provider1 = new Provider();
		provider1.setFirstName("John");
		provider1.setLastName("Doe");
		provider1.setNpi("78364565533");
		provider1.setState("NY");

		Provider provider2 = new Provider();
		provider2.setFirstName("Anna");
		provider2.setLastName("Bates");
		provider2.setNpi("82825361425");
		provider2.setState("CA");
